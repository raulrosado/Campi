...
class AdapterCampismosPopularesProvincia extends RecyclerView.Adapter<AdapterCampismosPopularesProvincia.ViewHolderDatos> implements View.OnClickListener{
    List<Campismos> listaCampismos;
    Context context;
    private View.OnClickListener listener;
    ConexionSQLiteHelper conn;      //conexion a la bd

    public AdapterCampismosPopularesProvincia(List<Campismos> listaCampismos, Context context){
    ...
    public ViewHolderDatos onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_campismo_horizontal,null,false);
